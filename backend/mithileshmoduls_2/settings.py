"""
Django settings for mithileshmoduls_2 project.
...
ROOT_URLCONF = 'mithileshmoduls_2.urls'
...
WSGI_APPLICATION = 'mithileshmoduls_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithileshmoduls_2 API",
    "DESCRIPTION": "API documentation for mithileshmoduls_2 App",
    "VERSION": "v1",
}
